...
class Model {
  ...
  save(options) {
    ...
    return Promise.try(() => {
            ...
            if (options.defaultFields && !this.isNewRecord) {
              ...
              for (const key of Object.keys(afterHookValues)) {
                if (afterHookValues[key] !== beforeHookValues[key]
                  // Issue #11705 - Workaround to detect undefined value as a valid change
                  || afterHookValues.hasOwnProperty(key) != beforeHookValues.hasOwnProperty(key) ) {
      ...
      // Issue #11705 - Possible suspect
      //  * this.dataValues is my model updated with the hook
      //  * options.fields does contains my hook field name set to undefined
